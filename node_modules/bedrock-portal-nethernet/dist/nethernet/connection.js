...
exports.Connection = exports.maxMessageSize = void 0;
const debugFn = require('debug')('bedrock-portal-nethernet');
exports.maxMessageSize = 10_000;
class Connection {
    nethernet;
    connectionId;
    rtcConnection;
    ...
    promisedSegments;
    buf;
    constructor(nethernet, connectionId, rtcConnection) {
    ...
    write(data) {
        ...
        let segments = Math.ceil(data.length / exports.maxMessageSize);
        for (let i = 0; i < data.length; i += exports.maxMessageSize) {
            segments--;
            let end = i + exports.maxMessageSize;
            if (end > data.length)
                end = data.length;
